...
if __name__ == "__main__":
    ...
    parser.add_argument("--freqs", type=str, default="100,500,900", help="Comma separated freqs for multitone")
    ...
    if args.type == "sine":
        ...
        signal = generate_noise(args.duration, args.fs)
    elif args.type == "impulse":
        signal = generate_impulse(args.duration, args.fs)
    elif args.type == "multitone":
        freqs = [float(f) for f in args.freqs.split(",")]
        signal = generate_multi_tone(freqs, args.duration, args.fs)
